...
-(double)returnTouBiaoJiangLi
{
    ...
    DDLog(@"投标奖励 = %@",[NSNumber numberWithDouble:result]);
...
-(void)calculating
{
    ...
    liLv = liLv*(1-guanLiFei);
     ...
     DDLog(@"toubiaojine=%f qiXian=%lf  liLv=%lf  huanKuanFangshi=%@      toubiaojiangli=%lf",touBianJinE,qiXian,liLv,huanKuanFangshi,touBiaoJiangLi);
